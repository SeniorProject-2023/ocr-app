            ...
            class CoreDispatcher {
                ...
                static initMethods() {
                    if (!CoreDispatcher._coreDispatcherCallback) {
                        if (globalThis.DotnetExports !== undefined) {
                            CoreDispatcher._coreDispatcherCallback = globalThis.DotnetExports.UnoUIDispatching.Uno.UI.Dispatching.CoreDispatcher.DispatcherCallback;
                        }
                        else {
    ...
    (function (Http) {
        class HttpClient {
            ...
            static initMethods() {
                ...
                this.dispatchResponseMethod = Module.mono_bind_static_method("[Uno.UI.Runtime.WebAssembly] Uno.UI.Wasm.WasmHttpHandler:DispatchResponse");
                this.dispatchErrorMethod = Module.mono_bind_static_method("[Uno.UI.Runtime.WebAssembly] Uno.UI.Wasm.WasmHttpHandler:DispatchError");
            }
        }
    ...
    class jsCallDispatcher {
        ...
        static invokeOnMainThread() {
            if (!jsCallDispatcher.dispatcherCallback) {
                if (globalThis.DotnetExports !== undefined) {
                    jsCallDispatcher.dispatcherCallback = globalThis.DotnetExports.UnoUIDispatching.Uno.UI.Dispatching.CoreDispatcher.DispatcherCallback;
                }
                else {
            ...
            class Geolocator {
                static initialize() {
                    ...
                    if (!Geolocator.interopInitialized) {
                        const exports = (_e = (_d = (_c = (_b = (_a = globalThis.DotnetExports) === null || _a === void 0 ? void 0 : _a.Uno) === null || _b === void 0 ? void 0 : _b.Windows) === null || _c === void 0 ? void 0 : _c.Devices) === null || _d === void 0 ? void 0 : _d.Geolocation) === null || _e === void 0 ? void 0 : _e.Geolocator;
                        if (exports !== undefined) {
                            ...
                            Geolocator.dispatchAccessRequest = Module.mono_bind_static_method("[Uno] Windows.Devices.Geolocation.Geolocator:DispatchAccessRequest");
                            Geolocator.dispatchError = Module.mono_bind_static_method("[Uno] Windows.Devices.Geolocation.Geolocator:DispatchError");
                            Geolocator.dispatchGeoposition = Module.mono_bind_static_method("[Uno] Windows.Devices.Geolocation.Geolocator:DispatchGeoposition");
                        }
            ...
            class Accelerometer {
                static initialize() {
                    ...
                    if (window.DeviceMotionEvent) {
                        const exports = (_e = (_d = (_c = (_b = (_a = globalThis.DotnetExports) === null || _a === void 0 ? void 0 : _a.Uno) === null || _b === void 0 ? void 0 : _b.Windows) === null || _c === void 0 ? void 0 : _c.Devices) === null || _d === void 0 ? void 0 : _d.Sensors) === null || _e === void 0 ? void 0 : _e.Accelerometer;
                        if (exports !== undefined) {
