        ...
        class ExportManager {
            static async initialize() {
                if (Module.getAssemblyExports !== undefined) {
                    ...
                    globalThis.DotnetExports = { Uno: unoExports, UnoUI: unoUIExports };
                }
            }
        }
    ...
    (function (UI) {
        class WindowManager {
            ...
            /**
                ...
                */
            static init(isLoadEventsEnabled, containerElementId = "uno-body", loadingElementId = "uno-loading") {
            ...
            static buildReadyPromise() {
                return new Promise(resolve => {
                    Promise.all([WindowManager.buildSplashScreen(), UI.ExportManager.initialize()]).then(() => resolve(true));
                });
            }
            /**
